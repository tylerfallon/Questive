  ...
  var TrackerReactComponent = function (_Component) {                                                               // 25
    ...
    function TrackerReactComponent() {                                                                              // 31
      ...
      return _this;                                                                                                 // 31
                                                                                                                    ...
                                                                                                                    //
    TrackerReactComponent.prototype.autorunRender = function autorunRender() {                                      // 25
      var _this2 = this;                                                                                            // 59
                                                                                                                    //
      ...
      this.render = function () {                                                                                   // 62
        ...
        return _this2.autorunOnce('_renderComputation', oldRender);                                                 // 64
                                                                                                                    ...
                                                                                                                    //
    TrackerReactComponent.prototype.autorunOnce = function autorunOnce(name, dataFunc) {                            // 25
...
var TrackerReactMixin = {                                                                                           // 85
  componentWillMount: function componentWillMount() {                                                               // 86
    // No reactive computations needed for Server Side Rendering                                                    //
    if (Meteor.isServer) return;                                                                                    // 88
                                                                                                                    //
    this.autorunRender();                                                                                           // 90
  },                                                                                                                // 91
  componentWillUnmount: function componentWillUnmount() {                                                           // 92
    // No reactive computations needed for Server Side Rendering                                                    //
  ...
  autorunRender: function autorunRender() {                                                                         // 99
    var _this3 = this;                                                                                              // 99
                                                                                                                    //
  ...
  autorunOnce: function autorunOnce(name, dataFunc) {                                                               // 107
